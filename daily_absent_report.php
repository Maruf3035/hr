...
if (isset($_REQUEST['current_date'])) {
    ...
    $allData = $object_attendance->absentReport($date);
}
    ...
    <?php if ((isset($allData))) {
        ...
        foreach ($allData as $oneData) { ?>
		  <tr>
			 ...
			 <td><?php $deptData=$object_hr->departmentAbsent($oneData->department_id);
...
<?php if (isset($_REQUEST['current_date'])) {
    ...
    <a href="daily_absent_report_pdf.php?current_date=<?php echo $_REQUEST['current_date'] ?>" class='btn btn-success'>Download
																							  Report</a>
<?php } ?>
</body>
</html>