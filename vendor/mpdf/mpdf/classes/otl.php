...
////////////////////////////////////////////////////////////////
			if (($useOTL & 0xFF) && $GSUBscriptTag && $GSUBlangsys && $GSUBFeatures) {
				...
				if ($this->shaper == 'A') {
					...
					$omittags = 'locl ccmp nukt akhn rphf rkrf pref blwf vendor/autoload.phpf half pstf cfar vatu cjct init medi fina isol med2 fin2 fin3 ljmo vjmo tjmo';
					$usetags = $tags;
					if (!empty($this->mpdf->OTLtags)) {
				...
				//===================================
					...
					if ($this->shaper == 'I' || $this->shaper == 'S') {
						...
						$tags = 'locl ccmp pref blwf vendor/autoload.phpf pstf cfar';
					}
					...
					//-----------------------------------------------------------------------------------
					$tags = 'pres vendor/autoload.phps blws psts haln rlig calt liga clig mset';
				...
				//==============================
					...
					//-----------------------------------------------------------------------------------
					$tags = 'pref vendor/autoload.phpf blwf pstf';
					$this->_applyGSUBrulesSingly($tags, $GSUBscriptTag, $GSUBlangsys);
					...
					//-----------------------------------------------------------------------------------
					$tags = 'pres vendor/autoload.phps blws psts';
				...
				//==============================
					...
					//-----------------------------------------------------------------------------------
					$tags = 'locl ccmp pref blwf vendor/autoload.phpf pstf pres vendor/autoload.phps blws psts haln rlig calt liga clig mset  RQD';
					// pref blwf vendor/autoload.phpf pstf required for Tibetan
...
////////////////////////////////////////////////////////////////
			...
			if (($useOTL & 0xFF) && $GPOSscriptTag && $GPOSlangsys && $GPOSFeatures) {
				...
				//==============================
				$tags = 'vendor/autoload.phpm blwm mark mkmk curs cpsp dist requ'; // Default set
	...
	function _applyGSUBrulesIndic($usetags, $scriptTag, $langsys, $is_old_spec)
	{
		...
		// rphf, pref, blwf, half, vendor/autoload.phpf, pstf, and init are only applied where ['mask'] indicates:  INDIC::FLAG(INDIC::RPHF);
